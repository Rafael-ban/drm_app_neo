...
void prts_operator_log_entry(prts_operator_entry_t* operator){
    ...
    log_debug("description: %s", operator->description);
    log_debug("icon_path: %s", operator->icon_path);
    log_debug("disp_type: %d", operator->disp_type);
    log_debug("intro_video.enabled: %d", operator->intro_video.enabled);
    log_debug("intro_video.duration: %d", operator->intro_video.duration);
    log_debug("intro_video.path: %s", operator->intro_video.path);
    log_debug("loop_video.enabled: %d", operator->loop_video.enabled);
    log_debug("loop_video.duration: %d", operator->loop_video.duration);
    ...
    log_debug("opinfo_params.aux_text: %s", operator->opinfo_params.aux_text);
    log_debug("opinfo_params.staff_text: %s", operator->opinfo_params.staff_text);
    log_debug("opinfo_params.color: %x", operator->opinfo_params.color);
    log_debug("opinfo_params.logo_path: %s", operator->opinfo_params.logo_path);
    log_debug("opinfo_params.class_path: %s", operator->opinfo_params.class_path);
    log_debug("transition_in.type: %d", operator->transition_in.type);
    log_debug("transition_in.duration: %d", operator->transition_in.duration);
    log_debug("transition_in.background_color: %x", operator->transition_in.background_color);
    log_debug("transition_in.image_path: %s", operator->transition_in.image_path);
    log_debug("transition_loop.type: %d", operator->transition_loop.type);
    log_debug("transition_loop.duration: %d", operator->transition_loop.duration);
    log_debug("transition_loop.background_color: %x", operator->transition_loop.background_color);
    log_debug("transition_loop.image_path: %s", operator->transition_loop.image_path);
}
