...
lv_obj_t * ui_create_overlay_arknights(){
    ...
    lv_obj_t * img_tl_rhodes = lv_image_create(scr);
    lv_image_set_src(img_tl_rhodes, UI_OVERLAY_ARKNIGHTS_PREFIX "top_left_rhodes.png");
    lv_obj_align(img_tl_rhodes, LV_ALIGN_TOP_LEFT, 0, 0);

    lv_obj_t * img_bl_bar = lv_image_create(scr);
    lv_image_set_src(img_bl_bar, UI_OVERLAY_ARKNIGHTS_PREFIX "btn_left_bar.png");
    lv_obj_align(img_bl_bar, LV_ALIGN_BOTTOM_LEFT, 0, 0);

    lv_obj_t * img_br_fade = lv_image_create(scr);
    lv_image_set_src(img_br_fade, UI_OVERLAY_ARKNIGHTS_PREFIX "btn_right_fade.png");
    lv_obj_align(img_br_fade, LV_ALIGN_BOTTOM_RIGHT, 0, 0);


    lv_obj_t * img_tr_bar = lv_image_create(scr);
    lv_image_set_src(img_tr_bar, UI_OVERLAY_ARKNIGHTS_PREFIX "top_right_bar.png");
    lv_obj_align(img_tr_bar, LV_ALIGN_TOP_RIGHT, 0, 0);
    
    lv_obj_t * img_tl_rect = lv_image_create(scr);
    lv_image_set_src(img_tl_rect, UI_OVERLAY_ARKNIGHTS_PREFIX "top_left_rect.png");
    lv_obj_align(img_tl_rect, LV_ALIGN_TOP_LEFT, 60, 0);

    lv_obj_t * img_ak_bar = lv_image_create(scr);
    lv_image_set_src(img_ak_bar, UI_OVERLAY_ARKNIGHTS_PREFIX "ak_bar.png");
    ...
    lv_anim_set_duration(&tl_rhodes_anim, 60000);
